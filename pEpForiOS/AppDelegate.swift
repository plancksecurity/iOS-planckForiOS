...
extension AppDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        scheduleAppRefresh()
        AuditLoggingUtil.shared.logEvent(maxNumberOfDays: AppSettings.shared.auditLoggingMaxNumberOfDays, auditLoggerEvent: .stop) { error in
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        AuditLoggingUtil.shared.logEvent(maxNumberOfDays: AppSettings.shared.auditLoggingMaxNumberOfDays, auditLoggerEvent: .start) { error in
            UIUtils.show(error: error)
        }
    }
