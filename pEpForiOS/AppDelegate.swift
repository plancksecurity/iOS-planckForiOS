...
extension AppDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        scheduleAppRefresh()
        AuditLoggingUtil.shared.logEvent(maxLogTime: AppSettings.shared.auditLoggingTime, auditLoggerEvent: .stop) { error in
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        AuditLoggingUtil.shared.logEvent(maxLogTime: AppSettings.shared.auditLoggingTime, auditLoggerEvent: .start) { error in
            UIUtils.show(error: error)
        }
    }
