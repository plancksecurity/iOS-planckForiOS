...
extension KeySyncHandshakeService: KeySyncServiceHandshakeDelegate {
    func showHandshake(me: PEPIdentity, partner: PEPIdentity) { //BUFF: HERE: add completionhandler
        DispatchQueue.main.async { [weak self] in
            ...
            newAlertView.addAction(UIAlertAction(title: "Confirm", style: .default) { action in
                do {
