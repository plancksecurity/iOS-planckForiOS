...
class FolderTableViewController: UITableViewController {
    ...
    private func initialConfig() {
        ...
        refreshControl?.tintColor = UITraitCollection.current.userInterfaceStyle == .dark ? UIColor.primaryDarkMode : UIColor.primaryLightMode
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let iconTintColor : UIColor = UITraitCollection.current.userInterfaceStyle == .dark ? .primaryDarkMode : .primaryLightMode
        let img = fcvm.image?.withTintColor(iconTintColor)
