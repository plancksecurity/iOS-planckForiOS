...
extension UIUtils {
    ...
    static public func showSetOwnKeyAlertView(callback: @escaping (String?) -> Void) {
        DispatchQueue.main.async {
            guard let alertViewController = PEPAlertWithTextViewViewController.getSetOwnKeyAlertView(callback: callback) else {
