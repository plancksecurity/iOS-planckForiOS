...
class NetworkServiceTests: XCTestCase {
    ...
    func testSyncOneTime() {
        ...
        // ... send an email to trigger IDLE-new-mesaage response from server. 
        let expEmailsSent = expectation(description: "expEmailsSent")
        NetworkServiceTests.sendMailsToYourselfAndWait(cdAccount: cdAccount, expectation: expEmailsSent)
    ...
    static func sendMailsToYourselfAndWait(cdAccount: CdAccount, expectation: XCTestExpectation, numMails: Int = 1, addAttachment: Bool = false) {
        ...
        let outgoingMailsToSend = NetworkServiceTests.createOutgoingMailsToYourselfAndWait(
...
//        let expBackgroundTaskFinishedAtLeastOnce = testCase.expectation(
...
//        let expectationSmtpExecuted = testCase.expectation(description: "expectationSmtpExecuted")
