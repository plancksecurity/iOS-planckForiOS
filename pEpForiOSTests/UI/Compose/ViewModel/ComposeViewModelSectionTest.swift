//!!!: Huston! ComoseViewModel definately causes serious crashes in tets. The Dispatch .. in calculatePepRatingproblem! fires whenever after the actual test ran and causes postentionally every later test to crash!
////
