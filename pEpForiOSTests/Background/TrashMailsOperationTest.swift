...
class TrashMailsOperationTest: CoreDataDrivenTestBase {
    ...
    func testTrashCdMessages() {
        ...
        for m in originalMessages {
            ...
            //BUFF: unclear (to me) what the expected trashedStatus for a message in trash folder actually is. 
            // I _assume_ .none, as trashedStatus imu. signals the message has to be copied to trash folder. Which messages in trash folder should not
...
//        let numMails = 3
//        for i in 1...numMails {
//            let cdMessage = CdMessage.create()
//            cdMessage.from = from
//            if i == 1 {
//                cdMessage.parent = draftsFolder
//            } else {
//                cdMessage.parent = inboxFolder
//            }
//            cdMessage.shortMessage = "Some subject \(i)"
//            cdMessage.longMessage = "Long message \(i)"
//            cdMessage.longMessageFormatted = "<h1>Long HTML \(i)</h1>"
//            cdMessage.sendStatus = SendStatus.none
//            cdMessage.addTo(cdIdentity: to)
//            let imapFields = CdImapFields.create()
//            let imapFlags = CdImapFlags.create()
//            imapFields.localFlags = imapFlags
//            imapFlags.flagDeleted = true
//            imapFields.trashedStatus = Message.TrashedStatus.none
//            cdMessage.imap = imapFields
//            guard let message =  cdMessage.message() else {
//                XCTFail("Not convertable?")
//            }
//            message.save()
//            originalMessages.append(message)
//
